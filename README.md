...
function buyProduct() {
    ...
    $.ajax({
        url: "https://bonevn.net/ajaxs/client/buyProduct.php",
        method: "POST",
        dataType: "JSON",
        data: {
            token: token,
        ...
        success: function(data) {
            ...
            if (data.status == 'success') {
                ...
                $urlReturn = 'https://bonevn.net/client/order/' + data.transid;
...
<script src="https://bonevn.net/public/datum/assets/js/backend-bundle.min.js"></script>
<!-- Chart Custom JavaScript -->
<script src="https://bonevn.net/public/datum/assets/js/customizer.js"></script>
<script src="https://bonevn.net/public/datum/assets/js/sidebar.js"></script>
<!-- Flextree Javascript-->
<script src="https://bonevn.net/public/datum/assets/js/flex-tree.min.js"></script>
<script src="https://bonevn.net/public/datum/assets/js/tree.js"></script>
<!-- Table Treeview JavaScript -->
<script src="https://bonevn.net/public/datum/assets/js/table-treeview.js"></script>
<!-- SweetAlert JavaScript -->
<script src="https://bonevn.net/public/datum/assets/js/sweetalert.js"></script>
<!-- Vectoe Map JavaScript -->
<script src="https://bonevn.net/public/datum/assets/js/vector-map-custom.js"></script>
<!-- Chart Custom JavaScript -->
<script src="https://bonevn.net/public/datum/assets/js/chart-custom.js"></script>
<script src="https://bonevn.net/public/datum/assets/js/charts/01.js"></script>
<script src="https://bonevn.net/public/datum/assets/js/charts/02.js"></script>
<!-- slider JavaScript -->
<script src="https://bonevn.net/public/datum/assets/js/slider.js"></script>
<!-- Emoji picker -->
<script src="https://bonevn.net/public/datum/assets/vendor/emoji-picker-element/index.js" type="module"></script>
<!-- app JavaScript -->
<script src="https://bonevn.net/public/datum/assets/js/app.js"></script>
<!-- Dev By CMSNT.CO | FB.COM/CMSNT.CO | ZALO.ME/0947838128 | MMO Solution -->
<!-- Script Footer -->
</body>
